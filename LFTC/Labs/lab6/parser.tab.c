...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_instructions = 24,              /* instructions  */
...
{
       0,    49,    49,    56,    48,    74,    77,    82,    89,    90,
      93,    94,    95,    98,   104,   113,   122,   123,   130,   138,
     139,   147,   152,   157,   160
};
#endif
...
static const char *const yytname[] =
{
  ...
  "END", "READ", "WRITE", "ASSIGN", "PLUS", "MINUS", "MULT", "LPAREN",
  "RPAREN", "SEMICOLON", "COMMA", "IDENTIFIER", "NUMBER", "$accept",
  "program", "$@1", "$@2", "declarations", "id_list", "instructions",
  "instruction", "assign", "read", "write", "expression", "term", "factor",
...
{
       7,    12,    29,   -22,    16,   -22,   -22,    27,    12,   -22,
      -9,   -22,     2,   -22,    12,    12,     5,    -4,   -22,    18,
      19,    20,    28,   -22,   -22,     5,   -22,    15,    24,   -22,
     -22,   -22,   -22,   -22,   -22,   -22,     5,    10,     5,     5,
       5,    15,   -22,    24,    24,   -22
};
...
{
       0,     0,     0,    24,     0,     1,     2,     0,     0,     3,
       0,     6,     0,     5,     0,     0,     0,     0,     8,     0,
       0,     0,     0,     7,    14,     0,    22,    15,    16,    19,
      21,     4,     9,    10,    11,    12,     0,     0,     0,     0,
       0,    13,    23,    17,    18,    20
};
...
{
       4,    31,    15,    16,    37,    13,    14,    11,    15,    16,
       1,    22,     3,    23,    24,    41,    22,    25,     3,    38,
      39,     3,    26,    42,    38,    39,    43,    44,     3,     5,
       6,     8,    33,    34,    35,    40,    36,    45,    32
};

static const yytype_int8 yycheck[] =
{
       1,     5,     6,     7,    25,    14,    15,     8,     6,     7,
       3,    12,    16,    14,    15,    36,    17,    12,    16,     9,
      10,    16,    17,    13,     9,    10,    38,    39,    16,     0,
      14,     4,    14,    14,    14,    11,     8,    40,    17
};
...
{
       0,     3,    19,    16,    32,     0,    14,    20,     4,    22,
      23,    32,    21,    14,    15,     6,     7,    24,    25,    26,
      27,    28,    32,    32,    32,    12,    17,    29,    30,    31,
      32,     5,    25,    14,    14,    14,     8,    29,     9,    10,
      11,    29,    13,    30,    30,    31
};
...
#line 1159 "parser.tab.c"
  ...
  case 4: /* program: PROGRAM identifier SEMICOLON $@1 declarations $@2 instructions END  */
#line 67 "parser.y"
                 {
...
#line 1169 "parser.tab.c"
  ...
  case 6: /* id_list: identifier  */
#line 78 "parser.y"
                 {
                     add_variable((yyvsp[0].strval));
                     fprintf(asm_file, "    %s resq 1\n", (yyvsp[0].strval));
                 }
#line 1178 "parser.tab.c"
    break;

  case 7: /* id_list: id_list COMMA identifier  */
#line 83 "parser.y"
                 {
                     add_variable((yyvsp[0].strval));
                     fprintf(asm_file, "    %s resq 1\n", (yyvsp[0].strval));
...
#line 1187 "parser.tab.c"
  ...
  case 13: /* assign: identifier ASSIGN expression  */
#line 99 "parser.y"
                 {
...
#line 1206 "parser.tab.c"
  ...
  case 15: /* write: WRITE expression  */
#line 114 "parser.y"
                 {
